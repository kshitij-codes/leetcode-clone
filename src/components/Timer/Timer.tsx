...
const Timer: React.FC<TimerProps> = () => {
  ...
  return (
    <div>
      {showTimer ? (
        <div className="flex cursor-pointer items-center space-x-2 rounded bg-dark-fill-3 p-1.5 hover:bg-dark-fill-2">
        ...
        <div
          className="flex h-8 cursor-pointer items-center rounded p-1 hover:bg-dark-fill-3"
